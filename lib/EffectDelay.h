...
protected:
    ...
    MidiMapping<EffectDelay> midiMappings[mapCount] = {
        MidiMapping<EffectDelay>(this, "SET_TIME_RATIO", &EffectDelay::setTimeRatio),
        MidiMapping<EffectDelay>(this, "SET_MASTER_AMPLITUDE", &EffectDelay::setMasterAmplitude),
        MidiMapping<EffectDelay>(this, "SET_FILTER_CUTOFF", &EffectDelay::setCutoff),
        MidiMapping<EffectDelay>(this, "SET_FILTER_RESONANCE", &EffectDelay::setResonance),
        MidiMapping<EffectDelay>(this, "SET_FILTER_MODE", &EffectDelay::setMode),
        MidiMapping<EffectDelay>(this, "SET_SEC_0", &EffectDelay::setSec0),
        MidiMapping<EffectDelay>(this, "SET_SEC_1", &EffectDelay::setSec1),
        MidiMapping<EffectDelay>(this, "SET_SEC_2", &EffectDelay::setSec2),
        MidiMapping<EffectDelay>(this, "SET_SEC_3", &EffectDelay::setSec3),
        MidiMapping<EffectDelay>(this, "SET_SEC_4", &EffectDelay::setSec4),
        MidiMapping<EffectDelay>(this, "SET_SEC_5", &EffectDelay::setSec5),
        MidiMapping<EffectDelay>(this, "SET_SEC_6", &EffectDelay::setSec6),
        MidiMapping<EffectDelay>(this, "SET_SEC_7", &EffectDelay::setSec7),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_0", &EffectDelay::setAmplitude0),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_1", &EffectDelay::setAmplitude1),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_2", &EffectDelay::setAmplitude2),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_3", &EffectDelay::setAmplitude3),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_4", &EffectDelay::setAmplitude4),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_5", &EffectDelay::setAmplitude5),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_6", &EffectDelay::setAmplitude6),
        MidiMapping<EffectDelay>(this, "SET_AMPLITUDE_7", &EffectDelay::setAmplitude7),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_0", &EffectDelay::setFeedback0),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_1", &EffectDelay::setFeedback1),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_2", &EffectDelay::setFeedback2),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_3", &EffectDelay::setFeedback3),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_4", &EffectDelay::setFeedback4),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_5", &EffectDelay::setFeedback5),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_6", &EffectDelay::setFeedback6),
        MidiMapping<EffectDelay>(this, "SET_FEEDBACK_7", &EffectDelay::setFeedback7),
    };
