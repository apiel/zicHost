...
protected:
    ...
    MidiMapping<EffectFilter> midiMappings[mapCount] = {
        MidiMapping(this, "SET_CUTOFF", &EffectFilter::setCutoff),
        MidiMapping(this, "SET_RESONANCE", &EffectFilter::setResonance),
        MidiMapping(this, "SET_MODE", &EffectFilter::setMode),
    };
